...
ensureColumn('products', 'pick', 'pick TEXT');
ensureColumn('products', 'color_img', 'color_img TEXT');
ensureColumn('orders', 'coupon_code', 'coupon_code TEXT');
ensureColumn('orders', 'discount', 'discount INTEGER NOT NULL DEFAULT 0');
